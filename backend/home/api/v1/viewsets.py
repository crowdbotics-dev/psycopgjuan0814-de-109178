...
from home.models import Newmo,Newmo2,Newmo,Newmo2,Newmo,Newmo2
from .serializers import NewmoSerializer,Newmo2Serializer,NewmoSerializer,Newmo2Serializer,NewmoSerializer,Newmo2Serializer
